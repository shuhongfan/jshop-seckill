...
public interface HttpStatus {
    ...
    // 添加商品相关状态
    public static final int SEC_NOT_UP = 201;
    public static final int SEC_GOODS_NOT_EXSISTS = 202;
    public static final int SEC_ACTIVE_NOT_START = 203;
    public static final int SEC_ACTIVE_END = 204;
    public static final int SEC_GOODS_END = 205;
    public static final int SEC_GOODS_STOCK_FAIL = 206;
